/*
 Basic Primitives orgDiagram v1.0.36
...
primitives.orgdiagram.Controller.prototype._cleanLayout=function(){this._mouseDestroy();this.element.find("."+this.widgetEventPrefix).remove()};
